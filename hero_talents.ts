      ...
      return {
        tier1_left: {
          title: {
            ...
            vi: `Cầu Ma Thuật ${magicalOrbCd}s`,
        ...
        tier2_right: {
          ...
          description: {
            ...
            vi: `Cầu Ma Thuật sẽ làm mù những tướng địch mà nó bay xuyên qua. Tướng bị làm mù sẽ bị giảm tầm nhìn và không chia sẻ tầm nhìn với đồng đội trong ${blindDuration}s`,
      ...
      return {
        tier1_left: {
          title: {
            ...
            vi: `Sát thương của Quỷ Nộ +${SparrowAbilityData.TALENT_T1_LEFT_GROUND_SLAM_DAMAGE}`,
        ...
        tier2_left: {
          ...
          description: {
            ...
            vi: `Sát thương của Quỷ Nộ xuyên giáp và kháng phép, đồng thời gây thêm ${groundSlamDamage}% sát thương.`,
        ...
        tier2_right: {
          title: {
            ...
            vi: `Tà Phong ${toSecRaw(SparrowAbilityData.TALENT_T2_RIGHT_DASH_COOLDOWN)}`,
      ...
      return {
        tier1_left: {
          ...
          description: {
            ...
            vi: `Đòn đánh thường của bạn giảm <b>${ICeatAbilityData.AUTOATTACK_SLOW_MOVESPEED}</b> tốc chạy và giảm <b>${attackSpeedSlow}%</b> tốc đánh`,
        ...
        tier1_right: {
          title: {
            ...
            vi: `Hàn Ủng +${ICeatAbilityData.TALENT_T1_RIGHT_COLD_EMBRACE_BONUS_MS} tốc chạy`,
        ...
        tier2_left: {
          title: {
            ...
            vi: `+${icicleFreezeDuration}s mảnh băng`,
        ...
        tier2_right: {
          title: {
            ...
            vi: `Hàn Ủng +${toSecRaw(ICeatAbilityData.TALENT_T2_RIGHT_COLD_EMBRACE_DURATION)}s`,
      ...
      return {
        tier1_left: {
          title: {
            ...
            vi: `Tinh Bộ +${astralstepSlow}s làm chậm`,
        ...
        tier1_right: {
          title: {
            ...
            vi: `Tinh Kiếm ${toSecRaw(VeilAbilityData.TALENT_T1_RIGHT_ASTRAL_BLADES_COOLDOWN)}s`,
        ...
        tier2_left: {
          title: {
            ...
            vi: `Sát thương cường hoá +${fixed((VeilAbilityData.TALENT_T2_LEFT_ENHANCED_DAMAGE - 1) * 100, 1)}%`,
        ...
        tier2_right: {
          ...
          description: {
            ...
            vi:
              `Tinh Bộ - ${astralStepCooldown}s \n` +
              'Tinh Bộ sẽ hồi lại ngay cả khi không đánh trúng địch.',
            id:
      ...
      return {
        tier1_left: {
          title: {
            ...
            vi: `Cúc Đằng +${pricklyVineStunBonus}s choáng`,
        ...
        tier1_right: {
          title: {
            ...
            vi: `Hoa Phục Kích -${BelleAbilityData.TALENT_T1_RIGHT_FLORAL_AMBUSH_SLOW} tốc chạy`,
        ...
        tier2_left: {
          ...
          description: {
            ...
            vi: `Vụ nổ của Hoa Phục Kích hồi {floralAmbushHeal}% sát thương máu cho tất cả đồng minh gần đó $`,
        ...
        tier2_right: {
          title: {
            ...
            vi: `Cúc Đằng -${pricklyAttachDuration}s trễ`,
      ...
      return {
        tier1_left: {
          title: {
            ...
            vi: `Hắc Dạ Hồ La Bạc +${ThomasAbilityData.TALENT_T1_LEFT_SHADOW_CARROT_DAMAGE} sát thương`,
        ...
        tier2_left: {
          ...
          description: {
            ...
            vi: `Các đòn đánh thường gây hiệu ứng Khát máu, gây thêm ${bleedDamage} sát thương của anh  trong ${bleedDuration}s và giảm giáp địch đi ${ThomasAbilityData.TALENT_T2_LEFT_BLEED_ARMOR_REDUCTION}.
            \nHiệu ứng này có thể kích hoạt mỗi ${bleedCooldown}s.`,
        ...
        tier1_right: {
          title: {
            ...
            vi: `Shuriken ${shurrikenTossCooldown}`,
        ...
        tier2_right: {
          title: {
            ...
            vi: `Hắc Dạ Hồ La Bạc choáng ${carrotStun}s`,
      ...
      return {
        ...
        tier1_right: {
          ...
          description: {
            ...
            vi: `Nộ Cước tăng ${furiousKickLifesteal}% hút máu`,
        ...
        tier2_right: {
          title: {
            ...
            vi: `Thiên Cước ${toSecRaw(AlvarAbilityData.TALENT_T2_RIGHT_HEAVENLY_KICK_COOLDOWN)}s`,
      ...
      return {
        ...
        tier1_right: {
          title: {
            ...
            vi: `Tầm đánh +${ArelAbilityData.TALENT_T1_RIGHT_ATTACK_DISTANCE}px`,
        ...
        tier2_left: {
          title: {
            ...
            vi: `Bom Hẹn Giờ +${toSecRaw(ArelAbilityData.TALENT_T2_LEFT_TICKING_BOMB_STUN)}s choáng`,
        ...
        tier2_right: {
          ...
          description: {
            ...
            vi:
              ...
              `<br/> Bẫy tồn tại trong ${freezingTrapDuration} và cung cấp tầm nhìn trong phạm vi nhỏ.`,
            id:
      ...
      return {
        tier1_left: {
          ...
          description: {
            ...
            vi: `Khải Hoàn Tái Sinh hồi Hazel ${HazelAbilityData.TALENT_T1_LEFT_SHOCKWAVE_HEALING * 100}% sát thương máu.`,
        ...
        tier2_left: {
          title: {
            ...
            vi: `Sức Mạnh Công Lý +${toSecRaw(HazelAbilityData.TALENT_T2_LEFT_HAMMER_STUN_DURATION)}s choáng`,
        ...
        tier2_right: {
          title: {
            ...
            vi: 'Khải Hoàn Chấn Động miễn nhiễm',
          ...
          description: {
            ...
            vi: 'Hazel miễn nhiễm với tất cả sát thương và hiệu ứng khống chế trong khi Khải Hoàn Chấn Động đang được kích hoạt',
      ...
      return {
        tier1_left: {
          title: {
            ...
            vi: `Sét +${toSecRaw(KiraAbilityData.TALENT_T1_LEFT_ENH_ATTACK_DURATION)}s`,
        ...
        tier2_right: {
          ...
          description: {
            ...
            vi: `Sét giờ có thể chuỗi đến đơn vị gần nhất, có thể là địch hoặc đồng minh và áp dụng hiệu ứng Sét, giảm 25% qua mỗi đơn vị.`,
      ...
      return {
        tier1_left: {
          ...
          description: {
            ...
            vi: `Lựu đạn cháy, gây ${incendiaryGrenadeDamage}% máu tối đa sát thương phép mỗi giây trong một thời gian ngắn.`,
      ...
      return {
        tier1_left: {
          ...
          description: {
            ...
            vi: `Hồn Ma trở lại và hồi phục ${hauntedGhostsHealing}% sát thương gây ra.`,
        ...
        tier1_right: {
          title: {
            ...
            vi: `+${MagdaleneAbilityData.TALENT_T1_RIGHT_BONUS_STACKS} linh hồn tối đa`,
        ...
        tier2_right: {
          title: {
            ...
            vi: `+${MagdaleneAbilityData.TALENT_T2_RIGHT_MOVEMENT_SPEED_PER_STACK}% tốc chạy cho mỗi linh hồn`,
          },
        },
      }
    }
      ...
      return {
        tier1_left: {
          ...
          description: {
            ...
            vi: `Cầu cung cấp thêm ${PrimAbilityData.TALENT_T1_LEFT_PRIM_BONUS_MOVEMENT_SPEED} tốc chạy và ${PrimAbilityData.TALENT_T1_LEFT_PRIM_BONUS_ARMOR} giáp khi ở gần Prim.`,
        ...
        tier1_right: {
          title: {
            ...
            vi: `Khoảng cách tối đa cầu +${PrimAbilityData.TALENT_T1_RIGHT_PRIM_ADDITIONAL_BALL_DISTANCE}px`,
        ...
        tier2_right: {
          ...
          description: {
            ...
            vi: `Tăng sát thương và thời lượng choáng của Lực Hấp Dẫn lên ${fixed(PrimAbilityData.TALENT_T2_RIGHT_GRAVITATIONAL_PULL_DAMAGE_AND_DURATION * 100, 1)}%`,
      ...
      return {
        tier1_left: {
          ...
          description: {
            ...
            vi: `Đòn đánh thường nguyền rủa, phát nổ sau ${curseDelay}s, gây ${curseDamage} + ${curseApPercent}% sức mạnh phép thuật. Đánh lại mục tiêu đã bị nguyền không làm mới hay kích hoạt sớm hơn.`,
        ...
        tier1_right: {
          title: {
            ...
            vi: `Chuyển dạng: Tà Ác ${shiftCdReduction}s`,
        ...
        tier2_left: {
          ...
          description: {
            ...
            vi: `Khi chuyển dạng để lại một bản sao hắc ám tại vị trí cũ của bạn (giống kỹ năng Bản Sao Hắc Ám, nhưng gây ít hơn ${mirrorDamageReduction}% sát thương). Sử dụng lần hai để hoán đổi vị trí với nó, kích nổ sau ${recastDelay}s.`,
        ...
        tier2_right: {
          ...
          description: {
            ...
            vi: `Khi chuyển dạng còn trói chân tất cả tướng địch trúng đòn trong ${clawsRoot}s.`,
      ...
      return {
        tier1_left: {
          ...
          description: {
            ...
            vi: `Nếu nhận sát thương lớn hơn ${seedOfLifeThreshold}% máu hiện tại thì sẽ gieo một hạt giống hồi phục, hồi lại ${seedOfLifeHeal}% sát thương đã nhận trong ${seedOfLifeDuration}s và loại bỏ mọi hiệu ứng bất lợi. Thời gian hồi chiêu: ${seedOfLifeCooldown}s.`,
        ...
        tier1_right: {
          ...
          description: {
            ...
            vi: `Quật Gai và Thịnh Nộ Rừng Thiêng giờ cũng áp dụng ${groveMarkStacks} cộng dồn Ấn thiên nhiên.`,
        ...
        tier2_left: {
          title: {
            ...
            vi: `Quật Gai +${brambleSnapRootBonus}s trói buộc`,
        ...
        tier2_right: {
          ...
          description: {
            ...
            vi: `Thịnh Nộ Rừng Thiêng triệu hồi hạt giống thứ hai sau ${additionalWrathDelay}s. Lần bùng nổ này gây ${additionalWrathMod}% sát thương và làm choáng.`,
      ...
      return {
        tier1_left: {
          title: {
            ...
            vi: `Lệnh: Lao tới làm chậm +${dashSlowBonus}s`,
        ...
        tier1_right: {
          ...
          description: {
            ...
            vi: `Con rối khi lao tới giảm ${shredderArmorPerStack} giáp mục tiêu mỗi lần cộng dồn (tối đa ${shredderMaxStacks} lần, ${shredderMaxArmor} tối đa) trong ${shredderDuration}s.`,
        ...
        tier2_right: {
          ...
          description: {
            ...
            vi: `Sợi dây trói kéo dài thêm ${staticDurationBonus}s và làm choáng thêm ${stunDurationBonus}s.`,
